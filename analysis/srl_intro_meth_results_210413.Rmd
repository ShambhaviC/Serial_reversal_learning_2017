...
Progressive improvement on the serial reversal task as more reversals are experienced, evidence of rule-learning, has been shown in many different species: bumblebees [@strang_serial_2014], guppies [@boussard_brain_2020], two different species of great tits [@hermer_elevation-related_2018] and three different species of corvids [@bond_serial_2007-1]. Guppies, in fact, show an increase in their choice for the rewarded option; and corvids show significant transfer across stimulus modality, which is strong evidence for rule-learning. 
