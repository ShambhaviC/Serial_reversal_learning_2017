...
# setting the working directory just once - set this separately if needed
opts_knit$set(root.dir = "/Users/shambhavi/Google Drive/Experiments & Data/Serial_reversal_learning_2017/analysis/data/raw_data")
```
...
MasterTable <- read.csv2(file = paste0(root_dir, "meta_data/MasterTable.csv"), header = TRUE, sep = ";", na.strings = "NA")

daypathlist <- read.csv2(
  file = paste0("MasterTableSerialReversal.csv", sep = ""),
...
#knitr::opts_knit$set(root.dir = "/Users/shambhavi/Google Drive/Experiments & Data/Reversal Learning - La Selva_2017/reversal_learning/Analysis/Analysis/Raw Data")

# set this line here
knitr::opts_knit$set(root.dir = "/Reversal Learning - La Selva_2017/Analysis/Analysis/Raw Data")
...
** Table 2 - Occurrence of events other than rewarded events at the flowers ** 
