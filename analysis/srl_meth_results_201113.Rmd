...
The average preference of the bats for the S+ and the S- are shown in Figures 1a and 1b. Within the first 10 visits of a reversal block the animals' preference for the S+ is above 75%. In many blocks, especially on days 2 and 3, this preference for the S+ is close to 95%. This is nearly 'error-free' performance, as about 95% of the animals' visits are made to the rewarding option. 
```{r}
#----------------------------------------
...
## The bats' preference for the S+ increases in a reversal block and reaches an asymptote
...
```
The bats never demonstrated behaviour to show they had learned the 'rule' of reversal, i.e., a win-stay lose-shift strategy. The bats continued to make sampling errors and needed several unrewarded visits to learn that the reward contingencies had changed. 

## A model of the bats' behaviour
